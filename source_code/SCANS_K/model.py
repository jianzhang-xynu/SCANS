...
class IS_ConvLayer(nn.Module):
    def __init__(self):
        ...
        self.fcnnLayers1.add_module("linear1",nn.Linear(18, 5, bias=True))  
        ...
        self.fcnnLayers2.add_module("linear1",nn.Linear(216, 5, bias=True))  
